    ...
    def check_user_location_rights(self):
        ...
        for i in self:
            ...
            if self.env.user.restrict_locations:
                ...
                if i.location_id not in user_locations:
                    raise Warning(message % i.location_id.name)
                elif i.location_dest_id not in user_locations:
                    raise Warning(message % i.location_dest_id.name)
