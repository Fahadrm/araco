...
class PosOrder(models.Model):
    ...
    #                 lambda l: l.product_id.type in ['product', 'consu'] or l.product_id.is_pack):
    #             if line.product_id.is_pack and line.product_id.pack_stock_management != 'decrmnt_pack':
    #                 for wk_pack_product in line.product_id.wk_product_pack.filtered(
    #                         lambda l: l.product_name.type in ['product', 'consu']):
